...
SITE_URL = "https://riclife.palladius.eu/"
...
#config.action_mailer.smtp_settings = { :address => 'smtp.palladius.eu', :domain => Socket.gethostname }
  ...
  # ExceptionNotifier.email_prefix = "[RicLife] ENVIRONMENT_TBD " # APPLICATION TBD
  # ExceptionNotifier.sender_address = %( "Riclife Production Exception Notifier" <palladiusbonton@gmail.com> )
#end
